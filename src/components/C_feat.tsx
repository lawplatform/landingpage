...
export default function C_feat({ title, img, desc }: C_featProp) {
	return (
		<div className="p-10 bg-base-100 w-56 rounded-lg border border-slate-300 mb-3 mx-10 op mt-10 group duration-150 ease-out transition-transform hover:scale-105">
